...
export function transformProp(obj: Reactive<any>, from: string, to: string,transform?:(value:any) => any) {
  if (obj && obj[from]) {
...
export function transformProps(obj: Reactive<any>, props: Record<string, string>,transform?:(value:any, prop:string) => any) {
